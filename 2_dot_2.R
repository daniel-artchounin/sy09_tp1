...
plot(-1:1, -1:1, type="n", xlab='C1', ylab='C2', main='Représentation des variables dans le \nplan formé à partir de C1 et C2')
...
plot(-1:1, -1:1, type="n", xlab='C1', ylab='C3', main='Représentation des variables dans le \nplan formé à partir de C1 et C3')
...
plot(C[,1], C[,2], type="n", xlab='U1', ylab='U2', main='Représentation des individus dans le\n plan formé à partir de U1 et U2')
...
plot(C[,1], C[,3], type="n", xlab='U1', ylab='U3', main='Représentation des individus dans le\n plan formé à partir de U1 et U3')
...
biplot(res, xlab='U1', ylab='U2', main='Représentation de l\'ancienne base et des individus\n dans le plan formé à partir de U1 et U2')

pause()

# Représentation de l'ancienne base et des individus dans le plan formé à partir de U1 et U3
biplot(res, c(1,3), xlab='U1', ylab='U3', main='Représentation de l\'ancienne base et des individus\n dans le plan formé à partir de U1 et U3')
